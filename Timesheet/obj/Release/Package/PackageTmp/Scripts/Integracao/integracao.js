...
function mudarperiodo(periodoselecionado) {
  desabilita();
    ...
    document.getElementById('formlogs').action = relativepath + "Integration/Integration/";
    document.getElementById('formlogs').method = "post";
    document.getElementById('formlogs').submit();
}

function mudarconsultor(consultorselecionado) {
    desabilita();
    var consultorid = consultorselecionado.value;
    document.getElementById('formlogs').action = relativepath + "Integration/Integration/";
    document.getElementById('formlogs').method = "post";
    document.getElementById('formlogs').submit();
}

function mudarStatus(statusselecionado) {
    desabilita();
    var consultorid = statusselecionado.value;
    document.getElementById('formlogs').action = relativepath + "Integration/Integration/";
    document.getElementById('formlogs').method = "post";
    document.getElementById('formlogs').submit();
}
...
function ExportToExcel() {
    document.getElementById('formlogs').action = relativepath + "Integration/ExportToExcel/";
    document.getElementById('formlogs').method = "post";
    document.getElementById('formlogs').submit();
}